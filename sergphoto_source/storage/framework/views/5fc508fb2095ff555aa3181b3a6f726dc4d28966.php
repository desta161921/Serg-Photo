...
<div class="container__album">
    <div class="wrapper__album">
        ...
        <div class="invitation__container">
            <!-- <img id="template" width="220" height="277" src="<?php echo e(url('/img/template1.png')); ?>" alt="The template"> -->
                ...
                <div class="canvas-inputs">
                    ...
                    <div class="template">
                        <select id="input5" class="canvas-input">
                            <option value="<?php echo e(url('/img/weddingtemplate.png')); ?>">Wedding Template 1</option>
                            <option value="<?php echo e(url('/img/weddingtemplate2.png')); ?>">Wedding Template 2</option>
                        </select>
  ...
  <script>
        ...
        base_image.src = '<?php echo e(url("/img/weddingtemplate.png")); ?>';
    ...
    function uploadEx() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('/')); ?>/invite/save",
            headers: {
            ...
            success:function(data){
                ...
                window.location.href = "<?php echo e(url('/events/'. $event->event_Id .'/invitation')); ?>";
            },error:function(){
